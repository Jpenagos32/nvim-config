...
vim.keymap.set("n", "<leader>wj", "<C-w>j", { desc = 'Baja a la siguiente ventana split' })
vim.keymap.set("n", "<leader>wk", "<C-w>k", { desc = 'Sube a la anterior ventana split' })
vim.keymap.set("n", "<leader>wl", "<C-w>l", { desc = 'Va hacia la ventana derecha en split vertical' })
vim.keymap.set("n", "<leader>wh", "<C-w>h", { desc = 'Va hacia la ventana izquierda en split vertical' })
